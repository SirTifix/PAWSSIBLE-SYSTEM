...
<body>
   ...
   <section class="appointment-con">
    ...
    <div class="row justify-content-end align-items-center m-0">
        ...
        <div class="col-auto my-1">
            <a href="./appointment.php" class="appointment-btn"><i class="far fa-calendar-check"></i>Appointment</a>
        </div>
        <div class="col-auto my-1">
            <div class="d-flex align-items-center">
                <a href="" class="appointment-btn"><i class="far fa-clock"></i>Pending</a>
            </div>
        </div>
    </div> 
