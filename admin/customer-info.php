...
if (isset($_GET['customerID'])) {
  ...
  exit;
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $petName = $_POST['petNameAdd'];
        $petBirthdate = $_POST['petBirthdateAdd'];
        $petAge = $_POST['petAgeAdd'];
        $petBreed = $_POST['petBreedAdd'];
        $petType = $_POST['petTypeAdd'];
        $petGender = $_POST['petGenderAdd'];
        $petWeight = $_POST['petWeightAdd'];
        $petColor = $_POST['petColorAdd'];
        $pet = new Pet();
        ...
        $pet->created_at = $currentDateTime;
        $pet->updated_at = "";

        $result = $pet->add();

        if ($result) {
            header('Location: customer-info.php?customerID=' . $customer_id);
            exit;
        } else {
  ...
  require_once('./include/admin-header.php')
    ...
    require_once('./include/admin-sidepanel.php')
      ?>
                ...
                <div class="col-lx-7 col-lg-7 col-md-12">
                    <div class="create-vet-form-info">
                        <div class="icon-expand d-flex justify-content-end">
                            <a href="customer-expand-info.php?customerID=<?= $customer_id ?>" class=""><i
                                    class="fa fa-expand" aria-hidden="true" style="color: black;"></i></a>
                        </div>
                ...
                <div class="col-lx-5 col-lg-5 col-md-12">
                    <div class="create-vet-form-info-pet">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="pt-2">
                                <button class="add-pet-btn-info" type="button" data-bs-toggle="modal"
                  ...
                  ?>
                        <div class="form-pet-info">
                            <div class="pet-info-box">
                                <div class="mb-3 ps-3">
                                    <div class="d-flex">
                                        <label for="petName" class="forms-label-pet pe-5"
                                    ...
                                    <div class="d-flex">
                                        <label for="petType" class="forms-label-pet pe-4" style="font-weight: bold;">Pet
                                            Type:</label>
                                        <input type="text" class="form-control-pet" id="petType" name="petType" required
                                            value="<?php echo $petData['petType']; ?>">
                                    </div>
                                </div>
                                <a href="" class="view-pet-btn" data-bs-toggle="modal"
                                    data-bs-target="#viewPetModal<?php //echo $petData['petId']; ?>">View</a>
                            </div>
                        </div>

                        <div class="modal fade" id="viewPetModal<?php echo $petData['petId']; ?>" tabindex="-1"
                            aria-labelledby="viewPetModalLabel<?php echo $petData['petId']; ?>" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                ...
                                <form action="" method="post">
                                    <div class="form-body">
                                        <div class="d-flex mt-3">
                                            ...
                                            <input type="text" class="form-control" id="petNameAdd" name="petNameAdd"
                                                required>
                                        </div>

                                        <div class="d-flex">
                                            <label for="petBirthdate" class="forms-label fw-bold">Birth Date:</label>
                                            <input type="date" class="form-control" id="petBirthdateAdd"
                                                name="petBirthdateAdd" required>
                                        </div>

                                        <div class="d-flex">
                                            <label for="petAge" class="forms-label fw-bold">Pet Age:</label>
                                            <input type="text" class="form-control" id="petAgeAdd" name="petAgeAdd"
                                                required>
                                        </div>

                                        <div class="d-flex">
                                            <label for="petBreed" class="forms-label fw-bold">Breed:</label>
                                            <input type="text" class="form-control" id="petBreedAdd" name="petBreedAdd"
                                                required>
                                        </div>

                                        <div class="d-flex">
                                            <label for="petType" class="forms-label fw-bold">Pet Type:</label>
                                            <input type="text" class="form-control" id="petTypeAdd" name="petTypeAdd"
                                                required>
                                        </div>

                                        <div class="d-flex">
                                            <label for="petGender" class="forms-label fw-bold">Gender:</label>
                                            <input type="text" class="form-control" id="petGenderAdd"
                                                name="petGenderAdd" required>
                                        </div>

                                        <div class="d-flex">
                                            <label for="petWeight" class="forms-label fw-bold">Weight:</label>
                                            <input type="text" class="form-control" id="petWeightAdd"
                                                name="petWeightAdd" required>
                                        </div>

                                        <div class="d-flex">
                                            <label for="petColor" class="forms-label fw-bold">Color:</label>
                                            <input type="text" class="form-control" id="petColorAdd" name="petColorAdd"
                                                required>
                                        </div>
                            ...
                            <div class="modal-footer mt-3 d-flex justify-content-between align-items-center">
                                <div>
                                    <a href="" class="back-btn btn-secondary">Cancel</a>
                                </div>
                                <div>
                                    <button type="submit" class="save-vet-btn btn-secondary"
                                        id="addPetButton">Add</button>
                                </div>
                            </div>
                            </form>
                        </div>
        ...
        <!--View Pet Modal-->
        <section>
            <div class="modal fade" id="viewPetModal" tabindex="-1" aria-labelledby="viewPetModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="position-relative mt-5">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input type="date" class="form-control" id="state" name="state" required
                            ...
                            <div class="modal-footer mt-5 d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="view-medicalRecord.php?petID=<?php echo $petData['petId']; ?>" class="back-btn btn-secondary">View Medical
                                        Record</a>
                                </div>
                            </div>
                        </div>
