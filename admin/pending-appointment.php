                ...
                <table class="table table-striped table-sm">
                    ...
                    <tbody id="appointmentTableBody">
                        ...
                        foreach ($appointments as $appointment) {
                            ...
                            echo '<a href="" class="check-btn"><i class="fa-regular fa-circle-check m-1" aria-hidden="true"></i></a>';
                            echo '</div>';
                            echo '<div class="crud-btn">';
                        ...
                        <div class="modal-content">
                            ...
                            <div class="selected-details">
                                ...
                                <div class="input-container">
                                    ...
                                    <input type="text" class="input-appointment" id="petName${i}" name="petName${i}"
                                        required><br><br>
                                </div>

                                <div class="input-container">
                                    <label for="petType${i}">Type:</label>
                                    <input type="text" class="input-appointment" id="petType${i}" name="petType${i}"
                                        required><br><br>
                                </div>
                                <span class="underline"></span>
                            </div>
