...
<section class="veterinarian-con">
        ...
        <div style="position: absolute; bottom: 65vh; left: 40vh; color: #2A2F4F;">
       <h2> <strong> AVAILABLE DATE </strong></h2>
    </div> <br>
    <div style="position: absolute; bottom: 65vh; left: 135vh; color: #2A2F4F;">
    ...
    <div class="container">
      ...
      <div class="buttons-container">
        <button class="edit-btn">Edit Time and Date</button>
