...
$vaccineForm = new Vaccine();

if (isset($_POST['submit'])) {
    // Get form data
    $vaccine = htmlentities($_POST['Vaccine']);
    $vaccineType = htmlentities($_POST['vaccinetype']);
    $ageVaccine = htmlentities($_POST['age']);
    $dosage = htmlentities($_POST['dosage']);
    $weeks = htmlentities($_POST['weeksInterval']);
    $price = htmlentities($_POST['price']);
    $category = htmlentities($_POST['vaccinetype']);

    $success = $vaccineForm->add($vaccine, $vaccineType, $ageVaccine, $dosage, $weeks, $price, $category);
    ...
    <main>
        ...
        <section class="filter-con row">
            ...
            <div class="crud-btn col-5 justify-content-end">
                <a href="" class="crud-text" data-bs-toggle="modal" data-bs-target="#addVaccineModal"><i
                        class="fa-solid fa-circle-plus pe-2 pt-1" aria-hidden="true"></i>Add Vaccine</a>
            </div>
        </section>
                    ...
                    <div class="modal-content">
                            ...
                            <form action="" method="post">
                                <div class="mt-4 mx-5">
                                    <div class="d-flex">
                                        ...
                                        <input type="text" class="form-control-vaccine p-2" id="Vaccine" name="Vaccine"
                                            required>
                                    </div>
                                    <div class="d-flex">
                                        <label for="VaccineType" class="form-label-vaccine fw-bold p-2">Vaccine
                                            Type:</label>
                                        <select class="form-select form-control-vaccine" id="vaccinetype"
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <input type="text" class="form-control-vaccine p-2" id="age" name="age"
                                            required>
                                    </div>

                                    <div class="d-flex">
                                        <label for="dosage" class="form-label-vaccine fw-bold">Dosage:</label>
                                        <input type="text" class="form-control-vaccine" id="dosage" name="dosage"
                                            required>
                                    </div>

                                    <div class="d-flex">
                                        <label for="weeksInterval" class="form-label-vaccine fw-bold">Weeks
                                            Interval:</label>
                                        <input type="text" class="form-control-vaccine" id="weeksInterval"
                                            name="weeksInterval" required>
                                    </div>

                                    <div class="d-flex">
                                        <label for="price" class="form-label-vaccine fw-bold">Price:</label>
                                        <input type="text" class="form-control-vaccine" id="price" name="price"
                                            required>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <select class="form-select form-control-vaccine" id="petType" name="petType"
                                            required>
                                            <option value="">Select Pet Type</option>
                        ...
                        <div class="modal-footer justify-content-between" style="border: none;">
                            ...
                            <button type="submit" name="submit" class="btn btn-primary"
                                style="background-color: #303962; border: none;">Add</button>
                        </div>
                        </form>
                    </div>
                </div>
