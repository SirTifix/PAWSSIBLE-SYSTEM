            ...
            <form action="submit-booking2.php" class="needs-validation" method="post" novalidate>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-2  background-color">
                        ...
                        <input type="text" class="form-control" id="petname_<?php echo $i; ?>" name="petName[]" placeholder="Enter pet name" required />
                    </div>
                    <div class="form-group col-sm-2 background-color">
                        <label for="petType_<?php echo $i; ?>"><h5>Pet Type</h5></label>
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <textarea class="form-concerns" name="concerns[]" id="concerns_<?php echo $i; ?>"></textarea>
                    </div>
                </div>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Kebies</td>
                                                    <td>Cat</td>
                                                    <td> <button type="button" class="Select-button btn btn-primary" aria-expanded="requiredfalse">
                                                            Select
                                                        </button>
                                                    </td>
