...
<body>
                            ...
                            <form method="POST" action="reschedule-appointment.php">
                                <div class="selected-details">
                                    <div class="row">
                                        ...
                                        <button type="button" id="requestBtn" class="btn btn-primary"
                                            data-toggle="modal" data-target="#rescheduleConfirmModal"
                                            style="background-color:#2A2F4F" class="float-right">
                                            Reschedule Appointment
                                        </button>
                                        <!-- Reschedule Confirmation Modal -->
                                        <div class="modal fade" id="rescheduleConfirmModal" tabindex="-1" role="dialog" aria-labelledby="rescheduleConfirmModalLabel"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="rescheduleConfirmModalLabel">Confirm Reschedule</h5>
                                                        <button type="button" class="close" id="closeRequest" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body d-flex text-center my-3">
                                                        <h5>Are you sure you want to request for appointment reschedule?</h5>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                        <button type="submit" type="button" class="btn btn-primary" id="sendRequestBtn">Send Request</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="time-container cont-box">
                            <div class="time-slots-container cont-content">
                                ...
                                <div class="time-slots">
                                    <div class="time-slot" id="time-slot" data-bs-toggle="modal" type="button" data-bs-target="#modal"
    ...
    $(document).ready(function() {
        ...
        $("#requestBtn").click(function() {
            $("#rescheduleConfirmModal").modal('show');
        });

        $("#closeRequest").click(function() {
            $("#rescheduleConfirmModal").modal('hide');
        });
    });
    </script>
</body>
