<div class="side-panel d-flex flex-column">
    ...
    <div class="admin-header pt-2">Veterinarian</div>
    <h4 class="text-info"><?= $vetData['vetFirstname'] . " " . $vetData['vetLastname']?></h4>
    ...
    <div class="side-panel-links">
        ...
        <a href="account-settings.php" class="sidebar-text align-items-center"><i class="fa-solid fa-gear" aria-hidden="true"></i> Settings</a>
    </div>
</div>